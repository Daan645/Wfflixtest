        ...
        <div class="container mt-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Groente Sappen</li>
                </ol>
            </nav>
        </div>
    </section>
                        ...
                        <aside class="side-area product-side side-shadow mt-5">
                            ...
                            <div class="side-content">
                                <ul class="list">
                                    ...
                                    <li>
                                        <input type="radio"aria-label="radio button">
                                        <a href="vegtableproducts.view.php" style="color: red">Groente Sappen</a>
                                    </li>
                                </ul>
                            </div>
                        </aside>
                        ...
                        <div class="col-lg-12">
                            <div class="product-top d-flex justify-content-left align-items-center">
                                <div class="product-sec product-item">
                                    <h2 class="my-5">Groente Sappen</h2>
                                </div>
                            </div>
                        </div>
